...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.roller/version';Storage.PREFIX='com.martinmagni.roller/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-60B4E9C2D6CE8B5C','ce792387-eff9-4678-a933-427a0d598dc0');}
