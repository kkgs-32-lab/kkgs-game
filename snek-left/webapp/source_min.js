...
var Storage={};Storage.VERSION=1;Storage.PATH_VERSION='com.martinmagni.snekleft/version';Storage.PREFIX='com.martinmagni.snekleft/data/';Storage.LEGACY_PREFIX='/';Storage.stringToHex=function(str){var hex='';for(var i=0;i<str.length;i++){hex+=str.charCodeAt(i).toString(16)+" ";}
return hex;}
...
function pokiSendLevelData(){navigator.sendBeacon('https://leveldata.poki.io/fancade-615999797E89CDC8','d3c072b7-a0ed-48a4-b6c0-8553c5b62d3e');}
